...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.232"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 52216;
pub const RELAY_PORT: i32 = 52217;
pub const WS_RENDEZVOUS_PORT: i32 =52218;
pub const WS_RELAY_PORT: i32 = 52219;
