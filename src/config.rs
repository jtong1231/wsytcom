...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.67.127"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 51616;
pub const RELAY_PORT: i32 = 51617;
pub const WS_RENDEZVOUS_PORT: i32 =51618;
pub const WS_RELAY_PORT: i32 = 51619;
