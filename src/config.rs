...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("启启通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.66.32"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 51516;
pub const RELAY_PORT: i32 = 51517;
pub const WS_RENDEZVOUS_PORT: i32 =51518;
pub const WS_RELAY_PORT: i32 = 51519;
