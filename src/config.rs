...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.66.112"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 51816;
pub const RELAY_PORT: i32 = 51817;
pub const WS_RENDEZVOUS_PORT: i32 =51818;
pub const WS_RELAY_PORT: i32 = 51819;
