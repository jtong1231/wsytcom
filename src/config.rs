...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("梦议芸".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.67.128"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 52316;
pub const RELAY_PORT: i32 = 52317;
pub const WS_RENDEZVOUS_PORT: i32 =52318;
pub const WS_RELAY_PORT: i32 = 52319;
