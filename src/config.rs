...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("宝光云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.238"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 51716;
pub const RELAY_PORT: i32 = 51717;
pub const WS_RENDEZVOUS_PORT: i32 =51718;
pub const WS_RELAY_PORT: i32 = 51719;
